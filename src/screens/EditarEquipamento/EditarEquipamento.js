...
export default class EditarEquipamento extends React.Component {
  state = {
    items: [
  ...
  componentDidMount = async ()  =>{
   ...
   this.setState({tipo:{tipo:"EQUIPAMENTO"}});
   if(equipamento.marca){
    this.setState({desativado:false});

    this.setState({tipo:{tipo:"COMPUTADOR"}});
    this.setState({marca:equipamento.marca});
    this.setState({modelo:equipamento.modelo});
    this.setState({tipoDaMaquina:{tipo:equipamento.tipoDaMaquina}});
    this.setState({memoria:{tipo:equipamento.tipoMemoria}});
    this.setState({tamanho:equipamento.capacidadeMemoria});
    this.setState({processador:equipamento.processador});
